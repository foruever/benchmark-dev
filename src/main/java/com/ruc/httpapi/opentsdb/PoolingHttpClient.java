...
public class PoolingHttpClient {
	...
	private static final int DEFAULT_CONNECTION_TIMEOUT_MILLISECONDS = (600 * 1000);
	private static final int DEFAULT_READ_TIMEOUT_MILLISECONDS = (600 * 1000);
	private static final int DEFAULT_WAIT_TIMEOUT_MILLISECONDS = (600 * 1000);
	...
	public SimpleHttpResponse doPost(String url, String data)
		...
		requestEntity.setChunked(false);//chunked设为false sxg
...
//		requestEntity.setContentType("application/json");
	...
	public SimpleHttpResponse doPostWithGZip(String url, String path)
			throws IOException {
//		StringEntity requestEntity = new StringEntity(data);
